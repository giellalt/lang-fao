...
export default function smeGramRelease(entry: StringEntry): Command {
    let x = hfst.tokenize(entry, { model_path: "tokeniser-gramcheck-gt-desc.pmhfst" });
    ...
    x = cg3.vislcg3(x, { model_path: "after-speller-disambiguator.bin" });
    x = cg3.vislcg3(x, { model_path: "grammarchecker.bin" });
    x = divvun.suggest("suggest", x, {
